...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        {
            this.allObjects.RemoveAll(objEl => objEl is Racket);
            this.staticObjects.RemoveAll(objEl => objEl is Racket);
        ...
        public bool GameOver(List<GameObject> obj)
        {
            foreach (var o in obj)
	        {
                if ((o is Ball) && o.GetTopLeft().Row >= 23)
                {
                    return true;
                }
	        }
