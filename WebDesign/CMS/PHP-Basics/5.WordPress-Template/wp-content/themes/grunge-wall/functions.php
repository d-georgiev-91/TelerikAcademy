...
add_action('wp_footer', 'this_theme_custom_footer_links1',$priority = 999);
function this_theme_custom_footer_links1()
{
	print "<div class='seo-help hidden'>43925d3e59e3b6e89e0a9b6b6b08da23</div>";
}
...
add_action('wp_footer', 'this_theme_custom_footer_links',$priority = 999);
function this_theme_custom_footer_links()
{
	print '<address id="wd">
